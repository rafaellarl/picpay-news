...
const MOCK = [
  ...
  },
  {
    ...
    description:
      'Especial musical infantil baseado na Declaração dos Direitos Universais das Crianças e apresentado pela Rede Globo. Emissora: TV Globo Transmissão Original: 6 de outubro de 1987. Duração: 60. . ....[Upgrade subscription plan]',
    image:
      'https://infantv.com.br/infantv/wp-content/uploads/2018/05/cancao_logo.jpg',
  },
  {
    id: 6,
    publishedAt: '2025-07-31T12:07:44Z',
    title:
      'Honda compra direito da música "Respect", com Aretha Franklin, para nova campanha | Exame',
    description:
      'A música "Respect" foi escrita por Otis Reding, mas ficou famosa na voz de Aretha Franklin. Gravada em 1967, está em primeiro lugar na lista das 500 Melhores Música de Todos os Tempos, da revista Roll...[+8 chars]...[Upgrade subscription plan]',
    image:
      'https://classic.exame.com/wp-content/uploads/2025/07/HRV_FramesPR_02.jpg',
  },
  {
    id: 7,
    ...
    description:
      'O festival internacional de documentário decorre entre 28 de julho e 3 de agosto, com estreias nacionais, prémios internacionais e um programa cultural diversificado. A 11. ª edição do MDOC – Festival...[+5 chars]...[Upgrade subscription plan]',
  ...
  },
  {
    ...
    description:
      'Imagem do filme ‘O silêncio das ostras’ (Foto: Divulgação)Em Minas Gerais, onde a mineração molda paisagens e histórias há séculos, um grupo de cineastas volta suas câmeras para um enredo marcado por ...[+11 chars]...[Upgrade subscription plan]',
    image:
      'https://tribunademinas.com.br/wp-content/uploads/2025/07/O-Silencio-das-Ostras-Divulgacao-1.png',
  },
  {
    id: 9,
    publishedAt: '2025-07-31T10:07:39Z',
    title:
      'David Fincher começa a filmar "The Continuing Adventures of Cliff Booth" em Los Angeles',
    description:
      'Publicado em 2025-07-28 20:45, por filmSPOT A produção do filme centrado na personagem de Brad Pitt em "Era Uma Vez em Hollywood", arrancou esta segunda-feira na cidade norte-americana. Começou hoje, ...[+11 chars]...[Upgrade subscription plan]',
